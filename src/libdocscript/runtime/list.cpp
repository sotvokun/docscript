...
List::List() : DataType(DataType::Kind::List) {}

List::List(const raw_type& raw_list) : DataType(DataType::Kind::List)
{
...
List::List(const List& list) : DataType(DataType::Kind::List)
{
...
List::List(List&& list) : DataType(DataType::Kind::List)
{
    for (const auto& e : list._raw) {
...
DataType* List::rawptr_clone() const
{
