...
UnquoteSplicing::UnquoteSplicing(const ast::List& list) : SpecialForm(list)
{
...
Value UnquoteSplicing::operator()(Environment& env)
{
    List result;
...
Value UnquoteSplicing::expose_list(const List& val_list)
{
