...
{
public:
    Exception(ExceptionType t, const std::string& msg) : type(t), message(msg)
    {}
...
{
public:
    UnclosedList() : Exception(ExceptionType::Error, "unclosed list") {}
...
{
public:
    IllegalKeyword() : Exception(ExceptionType::Error, "illegal keyword") {}

    IllegalKeyword(const std::string& undefined_str)
        : Exception(ExceptionType::Error,
                    "illegal keyword, undefined: " + undefined_str)
    {}
};
...
{
public:
    RuntimeError(const std::string& msg) : Exception(ExceptionType::Error, msg)
    {}
};
...
{
public:
    NotProcedure() : Exception(ExceptionType::Error, "not a procedure") {}
};
