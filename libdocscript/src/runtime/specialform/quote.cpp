...
Quote::Quote(const ast::List& list) : SpecialForm(list)
{
...
Value Quote::operator()(Environment& env)
{
...
Value Quote::process(const ast::Expression& expr, Environment& env)
{
...
Value Quote::process_atom(const ast::Atom& atom, Environment& env)
{
...
Value Quote::process_list(const ast::List& list, Environment& env)
{
    List result;
