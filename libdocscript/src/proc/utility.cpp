...
Number Utility::number_func_helper(args_list args, func_num_1 func)
{
...
Number Utility::number_func_helper(args_list args, func_num_1_multiple func)
{
...
Number Utility::number_func_helper(args_list args, func_num_2 func)
{
...
Number Utility::number_func_helper(args_list args, func_num_2_multiple func)
{
...
Number Utility::number_func_helper(args_list args, func_num_multiple func)
{
    for (const auto& val : args) {
        if (val.type() != DataType::Kind::Number)
            throw UnexceptType(DataType::to_string(DataType::Kind::Number),
...
std::string Utility::ltrim(const std::string& str)
{
...
std::string Utility::rtrim(const std::string& str)
{
